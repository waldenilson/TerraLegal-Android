...
public class ConsultaTituloActivity extends Activity implements IActivity{
	...
	private void init(){
		nome = (EditText) findViewById(R.id.et_titulo_nome);
		cadastro_pessoa = (EditText) findViewById(R.id.et_titulo_cadastro_pessoa);
	}
