...
public class ConsultaPecaActivity extends Activity implements IActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_consulta_peca);
	...
	private void init(){
		nome = (EditText) findViewById(R.id.et_peca_nome);
		cadastro_pessoa = (EditText) findViewById(R.id.et_peca_cadastro_pessoa);
	}
	...
	public void bt_pesquisar(View v)
	{
		...
		if( nome.getText().toString().length() > 2 || cadastro_pessoa.getText().toString().length() > 2 )
		{
			...
			Intent data = new Intent(this, PecasActivity.class);
